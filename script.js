document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        anchor.addEventListener('click', function(e) {
            ...
            } else if (targetId.startsWith('#phase3-')) {
                const btnPhase3 = document.querySelector('.cta-button-phase[data-phase="phase3"]');
                if (btnPhase3 && !btnPhase3.classList.contains('active')) {
                    btnPhase3.click();
                }
